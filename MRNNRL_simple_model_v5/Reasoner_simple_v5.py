...
class Reasoner_simple_v5(torch.nn.Module):
    def __init__(self, args, entity_embedding, relation_embedding, news_title_embedding, device):
        ...
        # self.node_embedding = nn.Embedding.from_pretrained(self.node_embeddings).to(self.device)
