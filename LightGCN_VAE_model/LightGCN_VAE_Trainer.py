...
class Trainer():
    ...
    def optimize_LightGCN_VAE(self, loss,):
    ...
    def _train_epoch(self):
        ...
        for data in self.train_dataloader:
            ...
            loss, scores, rec_loss, emb_loss = self.LightGCN_VAE_model(user_index, candidate_newindex,user_clicked_newindex, label)
            self.optimize_LightGCN_VAE(loss)
    ...
    def _save_checkpoint(self, epoch):
        state_agent = self.LightGCN_VAE_model.state_dict()
    ...
    def test(self):
        ...
        with no_grad():
            for data in self.test_dataloader:
                ...
                scores = self.LightGCN_VAE_model.test(user_index, candidate_newindex, user_clicked_newindex)
