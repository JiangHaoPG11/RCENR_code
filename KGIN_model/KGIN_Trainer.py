...
class Trainer():
    ...
    def _train_epoch(self):
        ...
        for data in self.train_dataloader:
            ...
            loss, scores, rec_loss, emb_loss = self.KGIN_model(user_index, candidate_newindex, label)
            print(rec_loss)
            print(emb_loss)
    ...
    def _save_checkpoint(self, epoch):
        state_agent = self.KGIN_model.state_dict()
    ...
    def test(self):
        ...
        with no_grad():
            for data in self.test_dataloader:
                ...
                scores = self.KGIN_model.test(user_index, candidate_newindex)
