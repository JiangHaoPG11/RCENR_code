...
class Trainer():
    def __init__(self, args, VAE_model, optimizer_VAE, data):
        self.args = args
        self.VAE_model = VAE_model
        self.optimizer_VAE = optimizer_VAE
        self.save_period = 100
        self.vaild_period = 400
    ...
    def _train_epoch(self):
        ...
        for data in self.train_dataloader:
            ...
            loss, scores, rec_loss = self.VAE_model(user_index, candidate_newindex, user_clicked_newindex, label)
            self.optimize_VAE(loss)
    ...
    def _save_checkpoint(self, epoch):
        state_agent = self.VAE_model.state_dict()
    ...
    def test(self):
        ...
        with no_grad():
            for data in self.test_dataloader:
                ...
                scores = self.VAE_model.test(user_index, candidate_newindex, user_clicked_newindex)
