from MCCLK_model.MCCLK import MCCLK_model
from MCCLK_model.MCCLK_Trainer import Trainer
import torch

class MCCLK_Train_Test():
    def __init__(self, args, data, device):
        ...
        MCCLK = MCCLK_model(args, news_title_embedding, entity_embedding, relation_embedding, news_entity_dict,  entity_adj, relation_adj, user_click_dict).to(device)
        optimizer_MCCLK = torch.optim.Adam(MCCLK.parameters(), lr = 0.0001)
        self.trainer = Trainer(args, MCCLK, optimizer_MCCLK, data)
