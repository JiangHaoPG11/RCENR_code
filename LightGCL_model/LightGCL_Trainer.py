...
class Trainer():
    ...
    def optimize_LightGCN(self, loss,):
    ...
    def _train_epoch(self):
        ...
        for data in self.train_dataloader:
            ...
            loss, scores, rec_loss, emb_loss = self.LightGCN_model(user_index, candidate_newindex, label)
            self.optimize_LightGCN(loss)
    ...
    def _save_checkpoint(self, epoch):
        state_agent = self.LightGCN_model.state_dict()
    ...
    def test(self):
        ...
        with no_grad():
            for data in self.test_dataloader:
                ...
                scores = self.LightGCN_model.test(user_index, candidate_newindex)
