from LightGCN_model.LightGCN import LightGCN_model
...
class LightGCN_Train_Test():
    def __init__(self, args, data, device):
        ...
        LightGCN = LightGCN_model(args, news_title_embedding, user_click_dict).to(device)
        optimizer_LightGCN = torch.optim.Adam(LightGCN.parameters(), lr = 0.001)
        self.trainer = Trainer(args, LightGCN, optimizer_LightGCN, data)
