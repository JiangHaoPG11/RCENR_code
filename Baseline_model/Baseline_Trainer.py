...
class Trainer():
    ...
    def _train_epoch(self):
        ...
        for data in self.train_dataloader:
            ...
            score = self.Baseline_model(user_index, user_clicked_newindex, candidate_newindex)
    ...
    def test(self):
        ...
        with no_grad():
            for data in self.test_dataloader:
                ...
                scores = self.Baseline_model.test(user_index, user_clicked_newindex, candidate_newindex)
